...
- `main`: versão atualmente publicada, com o fluxo inicial da landing page e direcionamento para o WhatsApp.
- `feature/...`: versão 2, com a evolução da solução para captura e gestão de leads, pesquisa, GA4 e dashboard.
